<template>
  ...
  >
    ...
    <!-- Content Overlay -->
    <div class="relative z-30 w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-32 h-full flex items-center">
      <div class="grid gap-16 lg:grid-cols-2 lg:items-center w-full">
